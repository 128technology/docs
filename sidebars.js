module.exports = {
  "docs": {
    ...
    "SSR 6.2.x Common Criteria Install and Configuration": [
      "cc_fips_6.2.x_titlepage",
      "cc_fips_6.2.x_intro",
      "cc_fips_6.2.x_compliance_guidelines",
      "cc_fips_6.2.x_ssr_security_scope",
      "cc_fips_6.2.x_secure_deliver",
      "cc_fips_6.2.x_intro_installation",
      "cc_fips_6.2.x_downloading_iso",
      "cc_fips_6.2.x_conductor_install",
      "cc_fips_6.2.x_otp_router_install",
      "cc_fips_6.2.x_install_quickstart_otpiso",
      "cc_fips_6.2.x_router_install",
      "cc_fips_6.2.x_access_mgmt",
      "cc_fips_6.2.x_config_ntp_auth",
      "cc_fips_6.2.x_config_password_policies",
      "cc_fips_6.2.x_config_audit_event",
      "cc_fips_6.2.x_sec_firewall_filtering",
      "cc_fips_6.2.x_banners",
      "cc_fips_6.2.x_oftware_upgrades",
      "cc_fips_6.2.x_appendix",
    ],
