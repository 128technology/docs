...
Once an SSR130 router is onboarded and synchronized with the conductor, upgrade it to SSR 7.1.5. Upgrades are initiated from the conductor and executed without requiring physical access to the router.
