...
---
import ConnectConsole from './_install_connect_console.md';
import BootUSBSSR100 from './_install_boot_usb_ssr100.md';
import BootUSBSSR1000 from './_install_boot_usb_ssr1000.md';
...
<img {useBaseUrl('/img/nmtui-linux-a.png')} alt="Configure the Ethernet port" width="192" height="243" />
...
If you choose to install routers using the Interactive Installation, continue with [Router Interactive Installation](cc_fips_router_install.mdx).
