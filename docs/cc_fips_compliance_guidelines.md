...
- When installing a router, the [IPv4 Option Filter](#ipv4-option-filtering) must be set to `drop-all`.
...
- Configure the [TCP Half-Open Connections Limit](#cc_fips_sec_firewall_filtering) for firewall.
