...
:::important
The asset-id must exactly match the router-name entered during the SSR130's initialization. The asset-id is how the device will be identified when it contacts the conductor.
:::
