...
------
- **I95-49633 Static assignment config is in multiple locations:** This is as designed, however cross-validation has been added to prevent the same ip-address from being configured as assigned to multiple dhcp-clients.
------
