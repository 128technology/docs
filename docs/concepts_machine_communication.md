...
By default, native TCP sessions use TCP, and UDP is used for all other session types. However, if firewall detection is enabled and [triggered](#firewall-detector), all traffic destined for a peer transitions to UDP. 
