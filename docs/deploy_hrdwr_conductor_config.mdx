...
## Next Step - Deploy a Router

Congratulations, your SSR1200 Conductor is deployed. The next step is to deploy your router(s) and onboard them to the conductor. See the appropriate router deployment guide for your needs. 
