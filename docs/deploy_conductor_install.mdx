...
2. At the Install menu, select **Serial**.
    ...
    :::note
    Select **Serial** when using a console cable (recommended for data-center installations). Select **VGA** only if you have a keyboard and monitor connected directly to the device. If no selection is made within 30 seconds, the system defaults to the **Serial Console** boot option.
    :::
