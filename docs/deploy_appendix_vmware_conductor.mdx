...
This appendix contains the complete SSR PCLI configuration for the `Conductor` VMware ESXi conductor described in this guide. Apply this configuration after completing [Step 3 — Configure the Conductor](deploy_vmware_conductor_config.mdx).
