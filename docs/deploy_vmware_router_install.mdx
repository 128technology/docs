---
title: "Step 2: Install SSR Software and Initialize the Spoke Router"
sidebar_label: "Install and Initialize the Spoke Router"
---
...
4. From the Spoke1 VM in the ESXi Navigator, select **Actions** and then **Edit Settings**.
   ...
   ![Mac Addresses](/img/dep10-vmrouter-mac-address.png)
