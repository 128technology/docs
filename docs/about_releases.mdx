...
Starting with version `6.1.0` will be the introduction of changes to the release model. Every six months, a new SSR software stream (i.e., bump in Major or Minor) will be released. Each software stream will have three phases of release - R1, followed by R2, followed by a final release. Initial feature content will be known as R1 (release candidate 1). R1 will be followed by additional feature content three months later in an R2 (release content 2). Between R1 and R2, there will be patch releases that contain bug fixes only. Once R2 is released, a customer must upgrade to R2 in order to remain on the same stream and to address any defects identified in R1. Three months following R2, the release will be designated as either Short Term Support (STS) or Long Term Support (LTS). Every other release will be designated as LTS (long term support).
...
| --- | --- | --- | --- | --- | --- |
| Release 6.1 | [6.1.0](release_notes_128t_6.1.md#release-610-55) | April 14, 2023 | [6.1.1](release_notes_128t_6.1.md#release-611-6) | January 14, 2024 |   July 14, 2024 |
| Release 5.6 | [5.6.7](release_notes_128t_5.6.md#release-567-4) | March 16, 2023 | [5.6.7](release_notes_128t_5.6.md#release-567-4) | June 16, 2023 | December 16, 2023 |
| Release 5.5 | [5.5.3](release_notes_128t_5.5.md#release-553-4) | August 11, 2022 | [5.5.8](release_notes_128t_5.5.md#release-558-7) | November 19, 2023 | May 19, 2024 |
...
| Release 5.1 | [5.1.3](release_notes_128t_5.1.md#release-513) | May 17, 2021 | [5.1.9](release_notes_128t_5.1.md#release-519-1) | August 24, 2022 | February 24, 2023 |

## Limited Availability 

| Version | Latest LA Version | 
| --- | --- |
| Release 6.0 | [6.0.9](release_notes_128t_6.0.md#release-609-3) |
