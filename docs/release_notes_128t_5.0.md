...
------
- **I95-9242 [Service and Topology Exchange Protocol (STEP)](concepts_STEP.md):** STEP facilitates the design and scale of new (and existing) networks by network administrators, and provides insight into service availability across the network. STEP is designed for service exchange and reachability to those services used by routers to efficiently route packets for each service. 
------
