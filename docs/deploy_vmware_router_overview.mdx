...
|------|-------|-------------|
| 1 | [Create each VMware VM](deploy_vmware_router_vm.mdx) | Create and configure a VMware ESXi VM to host the branch router and one to host the hub router. |
