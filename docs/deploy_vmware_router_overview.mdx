...
|------|-------|-------------|
| 1 | [Create the VMware VM](deploy_vmware_router_vm.mdx) | Create and configure a VMware ESXi VM to host the Spoke VM. |
...
| — | [Appendix — Router Configuration](deploy_appendix_vmware_router.mdx) | PCLI configuration examples. |

## Network Topology

The diagram below shows the logical network this guide builds.

![Spoke Config diagram](/img/dep-vmware-router-spoke1only.png)
