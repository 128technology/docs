...
```
8. Press Enter.
9. Insert your USB with the new ISO image into the USB port of the SSR device.
10. Power up the SSR device. 
11. Use the instructions below appropriate for your device (SSR1x0 or SSR1x00) to complete the re-imaging process.
