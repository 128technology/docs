...
Router installation can be performed using **either** the OTP process, or the [Interactive Installation](cc_fips_router_install.mdx). You do not need to perform both. **The steps in this section describes the OTP process.**
