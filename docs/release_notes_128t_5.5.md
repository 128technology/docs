...
------
- **I95-48076 SSR Failover on GRE tunnels not working:** The base interface giid is now used to identify the next hop state and correctly report, enabling failover to operate correctly.
------
