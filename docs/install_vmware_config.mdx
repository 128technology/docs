...
If you are installing a Conductor, please refer to [Step 3 Configure the Conductor](deploy_vmware_conductor.mdx#step-3-configure-the-conductor) in the VMWare Conductor Deployment Guide.
