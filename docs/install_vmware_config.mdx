...
7. Expand the CPU selection, and configure the following settings. Refer to the [Minimum Platform Specifications](about_supported_platforms.me#minimum-platform-specifications) and the Scaling Guidelines for additional requirements.
...
8. Click the **Add network adapter** button twice. You should have a minimum of three network adapters available. Configure as many as necessary for your deployment.  
