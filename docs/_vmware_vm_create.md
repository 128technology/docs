...
Use the steps below to configure the following:
   ...
   | Guest OS version | Highest available Oracle Linux (64-bit) version |
...
7. Click the **VM Options** tab.

   ![VM Options](/img/vmware_vmoptions1.png)

8. Expand **Boot Options**.

9.  Verify that **EFI** is selected. 
...
11. As shown in the image above, expand **CD/DVD Drive 1**. 

12. Place a check next to **Connect at power on**. In the dropdown to the right, select **Datastore ISO file** and then click **Browse**. The Datastore Browser opens.

13. Select the `SSR-7.1.4-3.r2.el9.x86_64.ibu-v1.iso` and click **Select**.

   ![CD ISO Selected](/img/dep7-vm-selectversion.png)

   ![Settings complete](/img/dep8-vm-all-settings.png)

14. Confirm the settings, and then click **Next**.

15. Review the summary, scroll to the bottom of the window and click **Finish**.
