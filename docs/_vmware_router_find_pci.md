...
3. Record the device names and addresses in your network design reference:
   ...
   :::important
   These are example values. Your device names and PCI addresses will differ. Use the values you discover here when you configure the router on the conductor.
   :::