...
## 1. Create the Router - THIS WAS DONE DURING INSTALL AND INTIALIZE
...
## 2. Create the Node - THIS WAS DONE DURING INSTALL AND INTIALIZE
...
3. Set the following fields:
   ...
   | Asset ID | `spoke1` | The asset ID reported in [Asset ID](deploy_vmware_router_install.mdx#asset-id) |
...
Keep this table until it is deemed unnecessary:
