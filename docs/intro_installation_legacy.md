...
- Legacy Installation 
   ...
   - [Install the Router using the OTP ISO](intro_otp_iso_install.md) or [Install the Router using the Interactive Installation](intro_installation_bootable_media.mdx)
