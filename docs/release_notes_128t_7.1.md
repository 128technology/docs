...
It is strongly recommeded that conductor-managed routers running SSR software versions earlier than 6.3.5 be upgraded to fully supported software versions. 
